...
baseOutDir = '/eos/user/b/bjoshi/www/EGM/TnP/PromptReco_official/tnpEleID_PromptReco2023D/'
puFile = '/eos/cms/store/group/phys_egamma/tnpTuples/bjoshi/2023-08-15/2022/pu/DY_1j_madgraph_PromptReco2023D_tnpEleIDs.pu.puTree.root'
...
samplesDef = {
        'data'  : tnpSamples.Run3_124X_PromptReco_2023['data_Run2023D'].clone(),
...
weightName = 'weights_2023_runD.totWeight'
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_weight(weightName)
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
