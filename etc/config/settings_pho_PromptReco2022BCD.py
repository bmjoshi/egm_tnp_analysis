...
baseOutDir = '/eos/user/b/bjoshi/www/EGM/TnP/Run2022BCD_RunIIUL_binning/tnpPhoID_preEE/'
...
samplesDef = {
        'data'  : tnpSamples.Run3_124X_PromptReco2022_preEE['data_Run2022BCD'].clone(),
        'mcNom' : tnpSamples.Run3_124X_PromptReco2022_preEE['DY_1j_madgraph'].clone(),
        'tagSel': tnpSamples.Run3_124X_PromptReco2022_preEE['DY_1j_madgraph'].clone(),
        'mcAlt': None,
    }
...
puFile = '/eos/cms/store/group/phys_egamma/tnpTuples/bjoshi/2023-04-25/2022/pu/DY_1j_madgraph_preEE_tnpPhoID.pu.puTree.root'
