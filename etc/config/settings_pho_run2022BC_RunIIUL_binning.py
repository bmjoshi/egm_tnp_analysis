...
baseOutDir = '/eos/user/b/bjoshi/www/EGM/TnP/Run2022BC_RunIIUL_binning/tnpPhoID_preEE/'
...
samplesDef = {
        'data'  : tnpSamples.Run3Prelim_126X_preEE['data_Run2022BC'].clone(),
        'mcNom' : tnpSamples.Run3Prelim_126X_preEE['DY_1j_madgraph'].clone(),
        'tagSel': tnpSamples.Run3Prelim_126X_preEE['DY_1j_madgraph'].clone(),
        'mcAlt': None,
    }
...
puFile = '/eos/cms/store/group/phys_egamma/tnpTuples/bjoshi/2023-02-01/2022/pu/DY_1j_madgraph_preEE_tnpPhoID.pu.puTree.root'
weightName = 'weights_2022_runBC.totWeight'
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_weight(weightName)
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
...
tnpParNomFit = [
    ...
    "acmsP[60.,50.,80.]","betaP[0.05,0.01,0.08]","gammaP[0.1, -2, 2]","peakP[89.0,82.0,90.0]",
    "acmsF[60.,50.,80.]","betaF[0.05,0.01,0.08]","gammaF[0.1, -2, 2]","peakF[89.0,82.0,90.0]",
    ]
