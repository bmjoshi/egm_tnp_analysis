...
baseOutDir = '/eos/user/b/bjoshi/www/EGM/TnP/PromptReco_official/tnpPhoID_ReReco2022BCDE/'
puFile = '/eos/cms/store/group/phys_egamma/tnpTuples/bjoshi/2023-08-15/2022/pu/DY_1j_madgraph_preEE_tnpPhoID.pu.puTree.root'
...
samplesDef = {
        'data'  : tnpSamples.Run3_124X_ReReco_preEE['data_Run2022B'].clone(),
        'mcNom' : tnpSamples.Run3_124X_ReReco_preEE['DY_1j_madgraph'].clone(),
        'tagSel': tnpSamples.Run3_124X_ReReco_preEE['DY_1j_madgraph'].clone(),
        'mcAlt': None,
    }

## can add data sample easily

samplesDef['data'].add_sample(tnpSamples.Run3_124X_ReReco_preEE['data_Run2022C'].clone()) 
samplesDef['data'].add_sample(tnpSamples.Run3_124X_ReReco_preEE['data_Run2022D'].clone()) 
samplesDef['data'].add_sample(tnpSamples.Run3_124X_ReReco_preEE['data_Run2022E'].clone()) 
...
weightName = 'weights_2022_runBCDE.totWeight'
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_weight(weightName)
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
