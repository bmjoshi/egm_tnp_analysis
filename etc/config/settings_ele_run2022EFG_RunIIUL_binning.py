...
baseOutDir = '/eos/user/b/bjoshi/www/EGM/TnP/Run2022EFG_RunIIUL_binning/tnpEleId_postEE/'
puFile = '/eos/cms/store/group/phys_egamma/tnpTuples/bjoshi/2023-02-01/2022/pu/DY_1j_madgraph_postEE_tnpEleID.pu.puTree.root'
...
samplesDef = {
        'data'  : tnpSamples.Run3Prelim_126X_postEE['data_Run2022EFG'].clone(),
        'mcNom' : tnpSamples.Run3Prelim_126X_postEE['DY_1j_madgraph_postEE'].clone(),
        'tagSel': tnpSamples.Run3Prelim_126X_postEE['DY_1j_madgraph_postEE'].clone(),
        'mcAlt': None,
    }
