...
baseOutDir = '/eos/user/b/bjoshi/www/EGM/TnP/PromptReco_official/tnpEleReco_PromptReco2022FG/'
...
biningDef = [
   ...
   { 'var' : 'sc_pt' , 'type': 'float', 'bins': [10,20,35,50,100,200,500] },
]
...
#############################################################
### cut
cutBase   = 'tag_Ele_pt > 35 && abs(tag_sc_eta) < 2.17 && tag_Ele_Iso122X>0.92'
